---
uuid: 2963
title: Vim 8 中的 C/C++ 编译运行：类 vscode 的任务系统
status: publish
categories: 随笔
tags: Vim
slug: 
date: 2020-02-14 00:20
---
谦卑的向大家介绍我的新插件：[asynctasks.vim](https://github.com/skywind3000/asynctasks.vim)，一套类似 vscode 的 tasks 系统，用于解决 vim 下长期没法轻松优雅的编译/运行 C/C++ 程序的问题。这个插件我去年酝酿了很长时间了，今年打算给他做一点宣传。

最近两年 Vim/NeoVim 发展非常迅速，各种：异步补全/LSP/查错，DAP 等项目相继出现，就连 [vimspector](https://github.com/puremourning/vimspector) 这样以前只能奢望 emacs 的项目如今都出现了。
