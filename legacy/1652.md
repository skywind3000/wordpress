...
我在 Vim 插入模式下习惯 inoremap C-HJKL来上下左右移动，十分方便，可到了Atom里该怎么办？  
\-- File -> Open Your Keymap，按照注释设置你的新的键位，如：'alt-j': 'core:move-down'。

我再 Vim 下面喜欢设置各种indent，各种smart tab，tab expand再Atom里面怎么设置？  
\-- Settings 第一个面板就有。
...
我再 Vim 中喜欢使用 Taglist/Tagbar 来进行索引，来到 Atom 有没有类似的插件？  
...
我从 Vim 过来，如何实现Vim的 YouCompleteMe超级补全插件？  
...
我在 Vim 中喜欢用 vim-multiply-cursors 做批量操作，Atom怎么弄？  
\-- multi-cursor-plus

我再 Vim 中写python，过来 Atom 下找不到顺手的工具了怎么办？  
